<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchByLName.aspx.cs" Inherits="AddressBook.SearchByLName" %>
...
<!--LOGO-->
    ...
    <h1 style ="text-align: left">Search By Last Name</h1>
    <!--SEARCH FIELD-->
    <form id="form1" runat="server">
        <table style =" width:50px">
            <tr><td><asp:Textbox id ="searchlname" style="width:100%" runat="server" required ="true"></asp:Textbox><asp:button Text="Search" class="mybtn" runat="server" id ="searchbtn" OnClick="Searchbtn_Click"></asp:button></td></tr>        
        </table>
