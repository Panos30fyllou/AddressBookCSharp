...
<body>
    ...
    <h1 style ="text-align: left">Search By First Name</h1>
    <!--SEARCH FIELD-->
    <form id="form1" runat="server">
        <table style =" width:50px">
            <tr><td><asp:Textbox id ="searchfname" style="width:100%" runat="server" required="true"></asp:Textbox><asp:button Text="Search" class="mybtn" runat="server" id ="searchbtn" OnClick="Searchbtn_Click"></asp:button></td></tr>        
        </table>
        ...
        <asp:Button class="mybtn" ID="editbtn" runat="server" OnClick="Edit_Click" Text="Edit" Visible="false"/>
        <asp:Button class="mybtn" ID="savechangesbtn" runat="server" OnClick="savechanges_Click" Text="Save Changes" Visible ="false"/>
        <asp:Button class="mybtn" ID="deletebtn" runat="server" OnClick="Delete_Click" Text="Delete" Visible="false"/>
    </form>
</body>
</html>
